...
export default function Home() {
    return (
        <div className="mx-auto w-full max-w-7xl">
            {/* Hero Section */}
            <aside className="relative bg-green-50 text-green-900 rounded-lg border border-green-300 overflow-hidden sm:mx-16 mx-2 sm:py-16 shadow-md">
                <div className="relative z-10 max-w-screen-xl px-4 pt-10 pb-20 sm:py-24 mx-auto sm:px-6 lg:px-8">
                    <div className="max-w-xl mt-80 sm:mt-1 space-y-8 text-center sm:text-right sm:ml-auto">
                        <h2 className="text-4xl sm:text-5xl font-extrabold text-green-700">
                            Join the Cause
            ...
            {/* Tagline */}
            <h1 className="text-center text-2xl sm:text-5xl font-semibold text-green-700 py-10">
